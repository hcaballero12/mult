...
<body>
  ...
  <form action = "login.do" method = "post" class="form-inline">
	  <table class="table table-condensed">
	  	...
	  	<c:forEach items= "${manager}" var="current">
        		<tr>
         			 <td><input type="radio" name="id"  value="<c:out value="${current.getIssueNum()}" />"> </td>
  ...
  <button type="submit" class="btn btn-primary btn-lg btn-block" value = "closeIssue" name = "action">Close Issue</button>
