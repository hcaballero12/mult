...
public class EmployeeServiceServiceLocator extends org.apache.axis.client.Service implements employee.service.EmployeeServiceService {
    ...
    private java.lang.String EmployeeServicePort_address = "http://localhost:7001/EmployeeWS/EmployeeServiceService";
    ...
    public employee.service.EmployeeService getEmployeeServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public employee.service.EmployeeService getEmployeeServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            employee.service.EmployeeServicePortBindingStub _stub = new employee.service.EmployeeServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (employee.service.EmployeeService.class.isAssignableFrom(serviceEndpointInterface)) {
                employee.service.EmployeeServicePortBindingStub _stub = new employee.service.EmployeeServicePortBindingStub(new java.net.URL(EmployeeServicePort_address), this);
                _stub.setPortName(getEmployeeServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.employee/", "EmployeeServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.employee/", "EmployeeServicePort"));
        }
